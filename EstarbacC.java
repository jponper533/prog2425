public class EstarbacC {
    ...
    public static void main(String[] args) {
        ...
        while (seguirPidiendo) {
            ...
            if (pedido == 1) {
                ...
                // Bucle de tickets
                ticket = bucleTicket(bebidasPedidas, ticket, CAFE_SMALL, CAFE_MEDIUM, CAFE_BIG, TE_SMALL, TE_MEDIUM, TE_BIG, CHOCOLATE_SMALL, CHOCOLATE_MEDIUM, CHOCOLATE_BIG, INGREDIENTES_LIMITE, INGREDIENTES_PRECIO, seguirTicket, costeTotal);
                // Se imprime el ticket con todos los datos obtenidos
                ticket(ticket, cliente, telefono, costeTotal);
    ...
    private static String ticket(String ticket, String cliente, int telefono, double costeTotal) {
    ...
    private static int menuIngredientes() {
    ...
    private static String agregacionIngredientes(int ingrediente, String ticket) {
        switch (ingrediente) {
            case 1:
                ticket += "Leche";
                break;
    ...
    private static String bucleIngredientes(final int INGREDIENTES_LIMITE, int ingredientesAgregados,
            boolean seguirAgregando, String ticket) {
        while (seguirAgregando && ingredientesAgregados < INGREDIENTES_LIMITE) {

            // Se pregunta por ingredientes a añadir
            int ingrediente = menuIngredientes();
            // Limpiar buffer
            leer.nextLine();
            ...
            if (ingrediente != 0) {
                ...
                ticket = agregacionIngredientes(ingrediente, ticket);
    ...
    private static String bucleTicket(int bebidasPedidas, String ticket, final double CAFE_SMALL,
            final double CAFE_MEDIUM, final double CAFE_BIG, final double TE_SMALL, final double TE_MEDIUM, final double TE_BIG,
            final double CHOCOLATE_SMALL, final double CHOCOLATE_MEDIUM, final double CHOCOLATE_BIG, final int INGREDIENTES_LIMITE, final double INGREDIENTES_PRECIO,
            boolean seguirTicket, double costeTotal) {
        do {

            int bebida = menuBebida();
            ...
            if (bebida != 0) {
                ...
                // Se declara e inicializa la variable que controla el coste de la bebida
                // (incluyendo los ingredientes)
                ...
                // Se declara e inicializa la variable que controla cuantos ingredientes pidio
                // en esta bebida
                int ingredientesAgregados = 0;
                ticket = bucleIngredientes(INGREDIENTES_LIMITE, ingredientesAgregados, seguirAgregando, ticket);
